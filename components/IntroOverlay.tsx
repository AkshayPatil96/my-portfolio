...
//     // Hide hero title via JS (not SSR inline style) so Chrome can measure LCP
//     // at initial paint while the overlay is still covering the page.
...
//       .to(
//         overlay,
//         { scaleY: 0, transformOrigin: "top", duration: 0.55, ease: "power4.inOut" },
//         "-=0.05"
//       )
...
export default function IntroOverlay() {
  ...
  useEffect(() => {
    ...
    tl.to(bar, {
      ...
      .to(bar, { opacity: 0, duration: 0.2, ease: "power2.in" }, "-=0.05")
      .to(
        overlay,
        {
          scaleY: 0,
