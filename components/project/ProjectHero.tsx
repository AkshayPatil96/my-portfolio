...
export default function ProjectHero({ project }: ProjectHeroProps) {
  ...
  return (
    ...
    >
      {/* Watermark case-study number - visible depth layer behind the title */}
      <span
        className="absolute top-16 sm:top-10 right-0 font-headline leading-none tracking-tighter text-on-surface/[0.035] select-none pointer-events-none"
        style={{ fontSize: "clamp(9rem, 24vw, 19rem)" }}
        aria-hidden="true"
      >
        {cs.number}
      </span>
