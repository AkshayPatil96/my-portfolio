...
export const experiences: Experience[] = [
  {
    ...
    tags: ["React.js", "Node.js", "MongoDB", "AWS", "Redis"],
    isCurrent: true,
    details: [
      "Architected and shipped multi-tenant SaaS products on AWS EC2 + S3 + SES",
      "Built real-time features using Redis pub/sub and WebSocket channels",
      "Led API design with Express + Mongoose for healthcare and e-commerce domains",
      "Integrated Razorpay, Stripe, and third-party CMS pipelines into production apps",
      "Conducted code reviews and established Git workflow conventions for the team",
    ],
  },
  {
    id: 2,
    ...
    isCurrent: false,
    details: [
      "Completed a rigorous 8-month MERN stack curriculum with 2000+ hours of practice",
      "Built and deployed 12 full-stack projects from scratch to production",
      "Mastered REST API design, JWT authentication, and state management patterns",
      "Transitioned from a non-technical background into professional software engineering",
    ],
  },
  {
    id: 3,
    period: "2017 — 2020",
    label: "Entrepreneurial Era",
    title: "Café Owner",
    company: "Independent — Ashta, Maharashtra",
    tags: ["Operations", "Team Management", "P&L"],
    isCurrent: false,
    details: [
      "Managed all daily operations: inventory, vendor negotiations, and customer relations",
      "Built and led a team of 5, handling hiring, scheduling, and performance feedback",
      "Owned full P&L — grew revenue by 30% in year two through local marketing",
      "Developed problem-solving and leadership instincts that now inform engineering decisions",
    ],
  },
];
