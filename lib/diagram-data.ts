...
export const diagramConfigs: Record<string, DiagramConfig> = {
  "real-time-chat-platform": {
    ...
    nodes: [
      ...
      // DATA LAYER
      {
        ...
        position: { x: 880, y: 80 },
        tooltip:
          "Stores messages and conversations with cursor-based pagination",
      },
      {
        id: "redis",
        label: "⚡  Redis",
      ...
      // HEALTH MONITOR
      {
        ...
        dashed: true,
        tooltip:
          "Continuously checks container health and restarts unhealthy instances",
      },
    ],
    edges: [
  ...
  "warden-admin-panel": {
    eyebrow: "SYSTEM ARCHITECTURE",
    title: "Warden Admin Infrastructure",
    subtitle: "Split Deploy + Blue-Green",
    nodes: [
      // INFRASTRUCTURE
      {
        id: "users",
        ...
        group: "infra",
        position: { x: 0, y: 200 },
        tooltip: "Admin/Manager/Viewer browsers over HTTPS",
      },
      {
        id: "vercel",
        label: "▲  Vercel\nNext.js Web + Proxy Guard",
        group: "infra",
        position: { x: 280, y: 70 },
        tooltip:
          "App Router UI on Vercel; an edge proxy does a cheap session-presence redirect (defense in depth, not the real gate)",
      },
      {
        id: "nginx",
        label: "⚡  Nginx\nReverse Proxy + Blue-Green",
        group: "infra",
        position: { x: 600, y: 200 },
        badge: "Zero-Downtime",
        tooltip:
          "TLS termination, routing, and health-checked traffic switch on the SSH host",
      },
      ...
      // APPLICATION
      {
        ...
        group: "app",
        position: { x: 900, y: 90 },
        tooltip: "Stateless Express API instance in the blue-green pair",
      },
      {
        id: "api-green",
        label: "🐳  api-green\nExpress (Docker)",
      ...
      // DATA LAYER
      {
        ...
        tooltip:
          "Customers, subscriptions, invoices, users/roles, server-side sessions, and the audit log",
      },
      ...
      // CI/CD
      {
        ...
        position: { x: 0, y: 420 },
        tooltip:
          "lint → typecheck → test → build against a Postgres service, then SSH blue-green deploy",
      },

      // HEALTH / BLUE-GREEN SWITCH
      {
        id: "health-switch",
        label: "🩺  Health Check\nBlue-Green Switch",
        group: "infra",
